...
save_dict(xs_continuous, 'R_BA_xs_continuous'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(ts_continuous, 'R_BA_ts_continuous'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(xs_stochastic, 'R_BA_xs_stochastic'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(ts_stochastic, 'R_BA_ts_stochastic'+str(int(100*a))+'_'+str(int(100*b)))