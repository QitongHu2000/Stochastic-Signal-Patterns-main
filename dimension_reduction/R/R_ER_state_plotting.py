...
xs_continuous=load_dict('R_ER_xs_continuous'+str(int(100*a))+'_'+str(int(100*b)))
ts_continuous=load_dict('R_ER_ts_continuous'+str(int(100*a))+'_'+str(int(100*b)))[0]
xs_stochastic=load_dict('R_ER_xs_stochastic'+str(int(100*a))+'_'+str(int(100*b)))
ts_stochastic=load_dict('R_ER_ts_stochastic'+str(int(100*a))+'_'+str(int(100*b)))[0]
