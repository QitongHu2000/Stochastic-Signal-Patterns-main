...
for source in sources:
    ...
    for k in range(ks):
        ...
        xs_stochastic_total.append(np.mean(xs1_stochastic,axis=1).T.tolist()[0])
    xs_stochastic.extend(np.mean(xs_stochastic_total,axis=0).tolist())
    ts_stochastic.extend(ts1_stochastic.tolist())

save_dict(xs_continuous, 'R_celegans_xs_continuous'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(ts_continuous, 'R_celegans_ts_continuous'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(xs_stochastic, 'R_celegans_xs_stochastic'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(ts_stochastic, 'R_celegans_ts_stochastic'+str(int(100*a))+'_'+str(int(100*b)))