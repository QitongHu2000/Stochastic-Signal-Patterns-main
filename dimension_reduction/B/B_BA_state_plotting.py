...
xs_continuous=load_dict('B_BA_xs_continuous'+str(int(100*B))+'_'+str(int(100*C)))
ts_continuous=load_dict('B_BA_ts_continuous'+str(int(100*B))+'_'+str(int(100*C)))[0]
xs_stochastic=load_dict('B_BA_xs_stochastic'+str(int(100*B))+'_'+str(int(100*C)))
ts_stochastic=load_dict('B_BA_ts_stochastic'+str(int(100*B))+'_'+str(int(100*C)))[0]
