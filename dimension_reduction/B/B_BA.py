...
save_dict(xs_continuous, 'B_BA_xs_continuous'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(ts_continuous, 'B_BA_ts_continuous'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(xs_stochastic, 'B_BA_xs_stochastic'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(ts_stochastic, 'B_BA_ts_stochastic'+str(int(100*B))+'_'+str(int(100*C)))