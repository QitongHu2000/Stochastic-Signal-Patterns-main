...
save_dict(xs_continuous, 'B_celegans_xs_continuous'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(ts_continuous, 'B_celegans_ts_continuous'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(xs_stochastic, 'B_celegans_xs_stochastic'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(ts_stochastic, 'B_celegans_ts_stochastic'+str(int(100*B))+'_'+str(int(100*C)))