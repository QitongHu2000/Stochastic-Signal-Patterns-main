...
xs_continuous=load_dict('B_celegans_xs_continuous'+str(int(100*B))+'_'+str(int(100*C)))
ts_continuous=load_dict('B_celegans_ts_continuous'+str(int(100*B))+'_'+str(int(100*C)))[0]
xs_stochastic=load_dict('B_celegans_xs_stochastic'+str(int(100*B))+'_'+str(int(100*C)))
ts_stochastic=load_dict('B_celegans_ts_stochastic'+str(int(100*B))+'_'+str(int(100*C)))[0]
...
plt.savefig('B_celegans_state_'+str(int(100*B))+'_'+str(int(100*C))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()