...
xs_continuous=load_dict('E_BA_xs_continuous'+str(int(100*B)))
ts_continuous=load_dict('E_BA_ts_continuous'+str(int(100*B)))[0]
xs_stochastic=load_dict('E_BA_xs_stochastic'+str(int(100*B)))
ts_stochastic=load_dict('E_BA_ts_stochastic'+str(int(100*B)))[0]
