...
save_dict(xs_continuous, 'E_karate_xs_continuous'+str(int(100*B)))
save_dict(ts_continuous, 'E_karate_ts_continuous'+str(int(100*B)))
save_dict(xs_stochastic, 'E_karate_xs_stochastic'+str(int(100*B)))
save_dict(ts_stochastic, 'E_karate_ts_stochastic'+str(int(100*B)))