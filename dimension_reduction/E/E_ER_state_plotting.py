...
xs_continuous=load_dict('E_ER_xs_continuous'+str(int(100*B)))
ts_continuous=load_dict('E_ER_ts_continuous'+str(int(100*B)))[0]
xs_stochastic=load_dict('E_ER_xs_stochastic'+str(int(100*B)))
ts_stochastic=load_dict('E_ER_ts_stochastic'+str(int(100*B)))[0]
...
plt.savefig('E_ER_state_'+str(int(100*B))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()