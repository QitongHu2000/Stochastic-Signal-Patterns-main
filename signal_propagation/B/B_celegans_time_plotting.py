...
degree = load_dict('B_celegans_degree'+str(int(100*B))+'_'+str(int(100*C)))
time_continuous = load_dict('B_celegans_continuous'+str(int(100*B))+'_'+str(int(100*C)))
time_stochastic = load_dict('B_celegans_stochastic'+str(int(100*B))+'_'+str(int(100*C)))
# time_theory_continuous = load_dict('E_celegans_theory_continuous'+str(int(100*B)))
# time_theory_stochastic = load_dict('E_celegans_theory_stochastic'+str(int(100*B)))
...
plt.savefig('B_celegans_time_'+str(int(100*B))+'_'+str(int(100*C))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()