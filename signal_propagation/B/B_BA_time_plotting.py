...
time_continuous = load_dict('B_BA_continuous'+str(int(100*B))+'_'+str(int(100*C)))
time_stochastic = load_dict('B_BA_stochastic'+str(int(100*B))+'_'+str(int(100*C)))
...
plt.savefig('B_BA_time_'+str(int(100*B))+'_'+str(int(100*C))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()