...
# save_dict(degree, 'B_ER_degree'+str(int(100*B))+'_'+str(int(100*C)))
# save_dict(times_continuous, 'B_ER_continuous'+str(int(100*B))+'_'+str(int(100*C)))
# save_dict(times_stochastic, 'B_ER_stochastic'+str(int(100*B))+'_'+str(int(100*C)))
save_dict((np.mat(xn)-np.mat(x1))[0,to_nodes], 'B_ER_Deltas_continuous'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(times_theory_continuous, 'B_ER_theory_continuous'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(times_theory_stochastic, 'B_ER_theory_stochastic'+str(int(100*B))+'_'+str(int(100*C)))