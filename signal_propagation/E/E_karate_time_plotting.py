...
degree = load_dict('E_karate_degree'+str(int(100*B)))
time_continuous = load_dict('E_karate_continuous'+str(int(100*B)))
time_stochastic = load_dict('E_karate_stochastic'+str(int(100*B)))
# time_theory_continuous = load_dict('E_karate_theory_continuous'+str(int(100*B)))
# time_theory_stochastic = load_dict('E_karate_theory_stochastic'+str(int(100*B)))
...
time_stochastic=[i*np.abs(time_theory_stochastic[0]/time_stochastic[0]) for i in time_stochastic]
...
plt.savefig('E_karate_time_'+str(int(100*B))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()