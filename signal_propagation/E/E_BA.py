...
# save_dict(degree, 'E_BA_degree'+str(int(100*B)))
# save_dict(times_continuous, 'E_BA_continuous'+str(int(100*B)))
# save_dict(times_stochastic, 'E_BA_stochastic'+str(int(100*B)))
save_dict((np.mat(xn)-np.mat(x1))[0,to_nodes], 'E_BA_Deltas_continuous'+str(int(100*B)))
save_dict(times_theory_continuous, 'E_BA_theory_continuous'+str(int(100*B)))
save_dict(times_theory_stochastic, 'E_BA_theory_stochastic'+str(int(100*B)))