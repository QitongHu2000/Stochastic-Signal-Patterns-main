...
# save_dict(degree, 'R_ER_degree'+str(int(100*a))+'_'+str(int(100*b)))
# save_dict(times_continuous, 'R_ER_continuous'+str(int(100*a))+'_'+str(int(100*b)))
# save_dict(times_stochastic, 'R_ER_stochastic'+str(int(100*a))+'_'+str(int(100*b)))
save_dict((np.mat(xn)-np.mat(x1))[0,to_nodes], 'R_ER_Deltas_continuous'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(times_theory_continuous, 'R_ER_theory_continuous'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(times_theory_stochastic, 'R_ER_theory_stochastic'+str(int(100*a))+'_'+str(int(100*b)))