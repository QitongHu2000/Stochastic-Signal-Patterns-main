...
k=1
sources=[79,] #np.random.choice(G_edge.nodes, size=k)
...
# save_dict(degree, 'R_BA_degree'+str(int(100*a))+'_'+str(int(100*b)))
# save_dict(times_continuous, 'R_BA_continuous'+str(int(100*a))+'_'+str(int(100*b)))
# save_dict(times_stochastic, 'R_BA_stochastic'+str(int(100*a))+'_'+str(int(100*b)))
save_dict((np.mat(xn)-np.mat(x1))[0,to_nodes], 'R_BA_Deltas_continuous'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(times_theory_continuous, 'R_BA_theory_continuous'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(times_theory_stochastic, 'R_BA_theory_stochastic'+str(int(100*a))+'_'+str(int(100*b)))