...
degree = load_dict('R_BA_degree'+str(int(100*a))+'_'+str(int(100*b)))
time_continuous = load_dict('R_BA_continuous'+str(int(100*a))+'_'+str(int(100*b)))
time_stochastic = load_dict('R_BA_stochastic'+str(int(100*a))+'_'+str(int(100*b)))
# time_theory_continuous = load_dict('R_BA_theory_continuous'+str(int(100*a))+'_'+str(int(100*b)))
# time_theory_stochastic = load_dict('R_BA_theory_stochastic'+str(int(100*a))+'_'+str(int(100*b)))
Deltas_continuous=load_dict('R_BA_Deltas_continuous'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
...
plt.savefig('R_BA_time_'+str(int(100*a))+'_'+str(int(100*b))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()