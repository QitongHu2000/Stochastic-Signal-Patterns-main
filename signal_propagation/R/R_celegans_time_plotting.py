...
degree = load_dict('R_celegans_degree'+str(int(100*a))+'_'+str(int(100*b)))
time_continuous = load_dict('R_celegans_continuous'+str(int(100*a))+'_'+str(int(100*b)))
time_stochastic = load_dict('R_celegans_stochastic'+str(int(100*a))+'_'+str(int(100*b)))
# time_theory_continuous = load_dict('R_celegans_theory_continuous'+str(int(100*B)))
# time_theory_stochastic = load_dict('R_celegans_theory_stochastic'+str(int(100*B)))
Deltas_continuous=load_dict('R_celegans_Deltas_continuous'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
...
time_stochastic=[i*np.abs(np.mean(time_theory_stochastic)/np.mean(time_stochastic)) for i in time_stochastic]
...
plt.savefig('R_celegans_time_'+str(int(100*a))+'_'+str(int(100*b))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()